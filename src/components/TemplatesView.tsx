...
export const DEFAULT_TEMPLATES: PromptTemplate[] = [
  ...
  },
  {
    ...
    positivePrompt: '{prompt} architectural visualization, photoreal render, clean lines, soft daylight',
    negativePrompt: 'sketch, hand-drawn, noisy, low quality',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'Character concept art with dynamic posing',
    positivePrompt: '{prompt} character concept art, dynamic pose, expressive lighting, detailed costume',
    negativePrompt: 'flat shading, stiff pose, low detail, cluttered background',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
  ...
  },
  {
    ...
    description: 'Painterly concept art with bold brush strokes',
    positivePrompt: '{prompt} painterly concept art, visible brush strokes, rich color gradients, high fantasy',
    negativePrompt: 'photorealistic, sterile, low contrast, flat color',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
  ...
  },
  {
    ...
    description: 'Environment concept art with cinematic vistas',
    positivePrompt: '{prompt} environment concept art, sweeping vista, volumetric lighting, atmospheric perspective',
    negativePrompt: 'crowded, dull lighting, low detail, noisy',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
  ...
  },
  {
    ...
    description: 'Photoreal interior design visualization',
    positivePrompt: '{prompt} interior design visualization, modern furniture styling, global illumination, photoreal rendering',
    negativePrompt: 'clutter, messy, low light, unfinished',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'Clean line art with inking detail',
    positivePrompt: '{prompt} clean line art, crisp outlines, inked drawing, high contrast',
    negativePrompt: 'color, shading, gradients, paint',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'High contrast black and white photography',
    positivePrompt: '{prompt} black and white photography, dramatic lighting, fine grain, high contrast',
    negativePrompt: 'colorful, oversaturated, cartoon, illustration',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'Versatile general-purpose photography',
    positivePrompt: '{prompt} professional photography, sharp focus, natural lighting, depth of field',
    negativePrompt: 'blurry, noisy, low resolution, amateur snapshot',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'Landscape photography with dramatic lighting',
    positivePrompt: '{prompt} landscape photography, golden hour, expansive scenery, dramatic sky',
    negativePrompt: 'indoor, studio, artificial lighting, cluttered foreground',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
  ...
  },
  {
    ...
    description: 'Studio portrait photography with controlled lighting',
    positivePrompt: '{prompt} studio portrait, softbox lighting, rim light, clean backdrop, ultra detailed',
    negativePrompt: 'harsh flash, grainy, low light, candid snapshot',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'Polished product renders for marketing',
    positivePrompt: '{prompt} product render, studio lighting, seamless background, glossy reflections, advertising quality',
    negativePrompt: 'scratches, fingerprints, noisy, low poly',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'Loose pencil sketch style',
    positivePrompt: '{prompt} pencil sketch, construction lines, loose shading, concept rough',
    negativePrompt: 'digital painting, full color, polished, photoreal',
    isDefault: true,
    createdAt: Date.now(),
  },
  {
    ...
    description: 'Vehicle concept art with motion',
    positivePrompt: '{prompt} vehicle concept art, dynamic perspective, motion blur, reflective materials',
    negativePrompt: 'static profile, low detail, cartoonish, low poly',
    isDefault: true,
    createdAt: Date.now(),
  },
];
