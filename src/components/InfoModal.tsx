...
export const InfoModal: React.FC<InfoModalProps> = ({ open, onOpenChange }) => {
  const features = [
    ...
    },
    {
      ...
      title: 'Smart Editing',
      description: 'Edit images with natural language and precision masking tools',
    ...
    },
    {
      ...
      description: 'Offline caching, project boards, and full history tracking',
    ...
    },
    {
      ...
      description: 'Pre-built prompts and custom templates for faster workflow',
    ...
    },
    {
      ...
      description: 'Generate multiple variations and organize in custom boards',
    ...
    },
    {
      ...
      description: 'Advanced settings and parameters for professional results',
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 border border-gray-700 rounded-xl p-6 w-full max-w-5xl max-h-[90vh] overflow-y-auto z-50 shadow-2xl">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">Professional AI Image Generation Studio</p>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-6 bg-gradient-to-r from-purple-900/20 to-pink-900/20 rounded-xl border border-purple-500/20">
              <p className="text-base text-gray-200 leading-relaxed">
                ...
                AI POD Lite combines powerful image generation, intelligent editing, and professional 
                workflow tools in one seamless desktop application.
              </p>
            </div>
